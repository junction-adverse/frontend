  ...
  return (
    <Container>
      ...
      <Grid.Container gap={2} justify="center">
        <Grid xs={12} sm={4}>
          <CampaignCard tagline="Time to Focus" campaignTitle="Hacker Campaign" brand="Nocco" slogan="No Carbs Company" img="https://mir-s3-cdn-cf.behance.net/project_modules/fs/6a737c49328847.58b16b556dfca.jpg" icon="https://mir-s3-cdn-cf.behance.net/projects/404/9bd641143775165.Y3JvcCwyMTA4LDE2NDgsMCwyMTk.png" />
        </Grid>
        <Grid xs={12} sm={4}>
          <CampaignCard tagline="Limitless Harmony" campaignTitle="Running Campaign" brand="Vitamin Well" slogan="Elevate" img="https://trivarga.com/app/uploads/2021/06/Vitamin-Well-Markenbild-1680x840-2.jpg" icon="https://www.vitaminwell.com/wp-content/uploads/2016/06/1465998939.jpg" />
        </Grid>
        <Grid xs={12} sm={4}>
